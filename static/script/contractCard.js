$(document).ready(function () {
  ...
  document.getElementById("ctr_card_full_contract_number")
    ? document
        .getElementById("ctr_card_full_contract_number")
        .addEventListener("change", function () {
          editContractCardData(this);
          isEditContract();
        })
    : "";
  let ctr_card_full_cost = document.getElementById("ctr_card_full_cost");
  if (ctr_card_full_cost) {
    ctr_card_full_cost.addEventListener("focusin", function () {
      convertCost(this, "in");
    });
    ctr_card_full_cost.addEventListener("focusout", function () {
      convertCost(this, "out");
    });
    ctr_card_full_cost.addEventListener("change", function () {
      isEditContract();
    });
  }
  document.getElementById("ctr_card_contract_full_vat_label")
    ? document
        .getElementById("ctr_card_contract_full_vat_label")
        .addEventListener("click", function () {
          foo();
        })
    : "";
  document.getElementById("ctr_card_contract_full_prolongation_label")
    ? document
        .getElementById("ctr_card_contract_full_prolongation_label")
        .addEventListener("click", function () {
          foo2();
        })
    : "";
  ...
  if (ctr_card_date_start) {
    ctr_card_date_start.addEventListener("focusin", function () {
      convertOnfocusDate(this, "focusin");
    });
    ctr_card_date_start.addEventListener("focusout", function () {
      convertOnfocusDate(this, "focusout");
    });
    ctr_card_date_start.addEventListener("change", function () {
      isEditContract();
    });
  }
  let ctr_card_date_finish = document.getElementById("ctr_card_date_finish");
  if (ctr_card_date_start) {
    ctr_card_date_finish.addEventListener("focusin", function () {
      convertOnfocusDate(this, "focusin");
    });
    ctr_card_date_finish.addEventListener("focusout", function () {
      convertOnfocusDate(this, "focusout");
    });
    ctr_card_date_finish.addEventListener("change", function () {
      isEditContract();
    });
  }
  document.getElementById("id_ctr_card_attach_file")
    ? document
        .getElementById("id_ctr_card_attach_file")
        .addEventListener("click", function () {
          editFullNameUserCard();
        })
    : "";
  document.getElementById("id_ctr_card_add_reserve")
    ? document
        .getElementById("id_ctr_card_add_reserve")
        .addEventListener("click", function () {
          editFullNameUserCard();
        })
    : "";
  document.getElementById("id_ctr_hide_full_card_info_button")
    ? document
        .getElementById("id_ctr_hide_full_card_info_button")
        .addEventListener("click", function () {
          hideFullCardInfo();
        })
    : "";
  document.getElementById("ctr_card_contract_number")
    ? document
        .getElementById("ctr_card_contract_number")
        .addEventListener("change", function () {
          editContractCardData(this);
          isEditContract();
        })
  ...
  if (ctr_card_cost) {
    ctr_card_cost.addEventListener("focusin", function () {
      convertCost(this, "in");
    });
    ctr_card_cost.addEventListener("focusout", function () {
      convertCost(this, "out");
    });
    ctr_card_cost.addEventListener("change", function () {
      isEditContract();
    });
  }
  document.getElementById("ctr_card_contract_vat_label")
    ? document
        .getElementById("ctr_card_contract_vat_label")
        .addEventListener("click", function () {
          foo();
        })
    : "";
  document.getElementById("ctr_card_contract_prolongation_label")
    ? document
        .getElementById("ctr_card_contract_prolongation_label")
        .addEventListener("click", function () {
          foo2();
        })
    : "";
  document.getElementById("id_ctr_card_attach_file_button")
    ? document
        .getElementById("id_ctr_card_attach_file_button")
        .addEventListener("click", function () {
          showFullCardInfo();
        })
    : "";
  document.getElementById("id_ctr_card_multiselect_on")
    ? document
        .getElementById("id_ctr_card_multiselect_on")
        .addEventListener("click", function () {
          setMultiselectFillOn(this);
        })
    : "";
  document.getElementById("id_ctr_card_columns_settings")
    ? document
        .getElementById("id_ctr_card_columns_settings")
        .addEventListener("click", function () {
          hideFullCardInfo();
        })
    : "";
  document.getElementById("id_ctr_card_focus_in")
    ? document
        .getElementById("id_ctr_card_focus_in")
        .addEventListener("click", function () {
          hideFullCardInfo();
        })
    : "";
  $("#ctr_card_status_name")
    ? $("#ctr_card_status_name").on("select2:select", function (e) {
        editContractCardData(this);
        isEditContract();
      })
    : "";
  $("#ctr_card_obj")
    ? $("#ctr_card_obj").on("select2:select", function (e) {
        editContractCardData(this);
      })
    : "";
  $("#ctr_card_full_obj")
    ? $("#ctr_card_full_obj").on("select2:select", function (e) {
        editContractCardData(this);
      })
    : "";
  $("#ctr_card_partner")
    ? $("#ctr_card_partner").on("select2:select", function (e) {
        isEditContract();
      })
    : "";
  $("#ctr_card_full_status_name")
    ? $("#ctr_card_full_status_name").on("select2:select", function (e) {
        editContractCardData(this);
        isEditContract();
      })
    : "";
  ...
  document.getElementById("user_card_allow")
    ? document
        .getElementById("user_card_allow")
        .addEventListener("change", function () {
          isEditContract();
        })
    : "";
  document.getElementById("ctr_card_fot_value")
    ? document
        .getElementById("ctr_card_fot_value")
        .addEventListener("change", function () {
          isEditContract();
        })
    : "";
  document.getElementById("ctr_card_contract_description")
    ? document
        .getElementById("ctr_card_contract_description")
        .addEventListener("change", function () {
          isEditContract();
        })
    : "";
  document.getElementById("ctr_card_date_start")
    ? document
        .getElementById("ctr_card_date_start")
        .addEventListener("change", function () {
          isEditContract();
        })
    : "";
  document.getElementById("ctr_card_date_finish")
    ? document
        .getElementById("ctr_card_date_finish")
        .addEventListener("change", function () {
          isEditContract();
        })
    : "";
  ...
  document.getElementById("add_btn")
    ? document.getElementById("add_btn").addEventListener("click", function () {
        modalCreateNewContract();
      })
    : "";
  document.getElementById("user_card_crossBtnNAW")
    ? document
        .getElementById("user_card_crossBtnNAW")
        .addEventListener("click", function () {
          closeModal();
        })
    : "";
  document.getElementById("employeeCardWin")
    ? document
        .getElementById("employeeCardWin")
        .addEventListener("click", function () {
          closeModal();
        })
    : "";

  document.getElementById("create_contract_button_income_contract_frame")
    ? document
        .getElementById("create_contract_button_income_contract_frame")
        .addEventListener("click", function () {
          createNewContract(this);
        })
    : "";
  document.getElementById("create_contract_button_income_subcontract_frame")
    ? document
        .getElementById("create_contract_button_income_subcontract_frame")
        .addEventListener("click", function () {
          createNewContract(this);
        })
    : "";
  document.getElementById("create_contract_button_expenditure_contract_frame")
    ? document
        .getElementById("create_contract_button_expenditure_contract_frame")
        .addEventListener("click", function () {
          createNewContract(this);
        })
    : "";
  document.getElementById(
    "create_contract_button_expenditure_subcontract_frame"
  )
    ? document
        .getElementById("create_contract_button_expenditure_subcontract_frame")
        .addEventListener("click", function () {
          createNewContract(this);
        })
    : "";
  ...
  for (let i of tow_cost) {
    i.addEventListener("change", function () {
      undistributedCost(this);
    });
  }
  let checkbox_time_tracking = document.getElementsByClassName(
    "checkbox_time_tracking"
  );
  for (let i of checkbox_time_tracking) {
    i.addEventListener("click", function () {
      selectContractTow(this);
    });
  }
  let tow_cost_percent = document.getElementsByClassName("tow_cost_percent");
  for (let i of tow_cost_percent) {
    i.addEventListener("change", function () {
      undistributedCost(this, (percent = "percent"));
    });
  }
...
function selectContractTow(check_box) {
  ...
  if (check_box.checked) {
    ...
    //Даты вида работ
    var date_start = check_box
      .closest("tr")
      .getElementsByClassName("tow_date_start")[0];
    var date_finish = check_box
      .closest("tr")
      .getElementsByClassName("tow_date_finish")[0];
    //Даты из договора
    var contract_date_start = document.getElementById(
      "ctr_card_date_start"
    ).value;
    var contract_date_finish = document.getElementById(
      "ctr_card_date_finish"
    ).value;
    ...
    if (!date_start.value && contract_date_start) {
      if (!date_finish.value) {
        ...
        date_finish.value &&
        new Date(convertDate(date_finish.value)) >
          new Date(convertDate(contract_date_start))
      ) {
        date_start.value = contract_date_start;
      }
    }
    if (!date_finish.value && contract_date_finish) {
      if (!date_start.value) {
        ...
        date_start.value &&
        new Date(convertDate(date_start.value)) <
          new Date(convertDate(contract_date_finish))
      ) {
        date_finish.value = contract_date_finish;
      }
    }
    ...
    if (
      document.getElementsByClassName("ctr_card_multiselect_off")[0] ||
      !check_box.checked
    ) {
      return;
    }
    //Проверяем, есть ли нераспределенные средства, если нет - завершаем
    var undistributed = document.getElementById(
      "div_above_qqqq_undistributed_cost"
    );
    ...
    if (undistributed_cost_float < 0) {
      return alert(
        "1Нет нераспределенных ДС. Нельзя увеличить сумму вида работ"
      );
    }

    //Стоимость и процент родителя
    var tow_cost = check_box
      .closest("tr")
      .getElementsByClassName("tow_cost")[0];
    tow_cost = parseFloat(tow_cost.dataset.value);
    tow_cost = isNaN(tow_cost) ? 0 : tow_cost;

    var cell_tow_cost_percent = check_box
      .closest("tr")
      .getElementsByClassName("tow_cost_percent")[0];
    ...
    while (nextRow && tow_lvl > cur_lvl) {
      ...
      if (tow_lvl > cur_lvl) {
        ...
        tows_array = Object.assign(
          { tow_id: { lvl: tow_lvl, tow_cnt: 0 } },
          tows_array
        );
        console.log(undistributed_cost_float, cost_per_child);
        if (undistributed_cost_float < cost_per_child) {
          console.log(
            "Нет нераспределенных ДС. нельзя увеличить сумму вида работ"
          );
        ...
        console.log("___");
        if (
          !nextRow.getElementsByClassName("checkbox_time_tracking")[0].disabled
        ) {
          nextRow.getElementsByClassName("tow_cost_percent")[0].value =
            percent_list[tow_lvl] + " %";
          undistributedStatus = undistributedCost(
            nextRow.getElementsByClassName("tow_cost_percent")[0],
            (percent = "percent")
          );
          if (undistributedStatus === false) {
            break;
          }
          nextRow.getElementsByClassName("checkbox_time_tracking")[0].checked =
            new_status;
        }
...
function undistributedCost(
  ...
  if (!subtraction) {
    ...
    if (input_cost === false && dept_id && !subtraction) {
      ...
      undistributed_cost_float = isNaN(undistributed_cost_float)
        ? 0
        : undistributed_cost_float;
      ...
      if (undistributed_cost_float < 0 && cost1_float >= cost2_float) {
        ...
        if (cost2_float) {
          cost2_float = cost2_float.toFixed(2) * 1.0;
    ...
    if (percent) {
      ...
      var value_cost1_float = parseFloat(
        value_cost1
          .replaceAll(" ", "")
          .replaceAll(" ", "")
          .replace(value_type, "")
      ...
      console.log(
        `                        ${undistributed_cost_float} - ${tow_cost} + ${value_cost2_float}`
      );
      if (dept_id) {
        undistributed_cost =
          undistributed_cost_float - tow_cost + value_cost2_float;
        if (undistributed_cost < -0.001) {
          ...
          cell.value = cost2_float;
          console.log(
            "2Нет нераспределенных ДС. Нельзя увеличить сумму вида работ",
            undistributed_cost
          );
      ...
      value_cost1 = tow_cost.toFixed(2) * 1.0;
      ...
      if (dept_id) {
        undistributed_cost =
          undistributed_cost_float - cost1_float + cost2_float;
    ...
    if (input_cost === false && dept_id) {
      ...
      if (undistributed_cost_tc) {
        undistributed_cost_tc = undistributed_cost_tc.toFixed(2) * 1.0;
    ...
    cost1_float = cost1_float.toFixed(2) * 1.0;
    ...
    if (true) {
      var fot_cost_cell = cell
        .closest("tr")
        .getElementsByClassName("tow_fot_cost")[0];
      var fot_cost = (tow_cost * fot_cost_percent) / 100;
      var fot_cost2 = fot_cost;
      if (fot_cost2) {
        fot_cost2 = fot_cost2.toFixed(2) * 1.0;
    ...
    if (percent) {
      ...
      let tow_cost_percent = cell
        .closest("tr")
        .getElementsByClassName("tow_cost_percent")[0];
      tow_cost_percent.className = tow_cost_percent.className.replace(
        "manual",
        "calc"
      );
    }
    ...
    cell
      .closest("tr")
      .getElementsByClassName("checkbox_time_tracking")[0].checked = true;

    selectContractTow(
      cell.closest("tr").getElementsByClassName("checkbox_time_tracking")[0]
    );
  } else {
    if (dept_id) {
      // Обновляем значение нераспределенных средств
...
function editContractCardStatusName(val) {
  ...
  if (val == select1 && $("#ctr_card_status_name").val() != val_value) {
    ...
    val == select2 &&
    $("#ctr_card_full_status_name").val() != val_value
  ) {
...
function editContractCardData(val) {
  ...
  if (
    val_id == "ctr_card_full_contract_number" ||
    val_id == "ctr_card_contract_number"
  ) {
    ...
    val_id == "ctr_card_full_status_name" ||
    val_id == "ctr_card_status_name"
  ) {
    const select1 = document.getElementById("ctr_card_full_status_name");
    const select2 = document.getElementById("ctr_card_status_name");
...
function convertCost(val, status) {
  ...
  if (status == "in") {
    ...
    undistributed_cost_float = isNaN(undistributed_cost_float)
      ? 0
      : undistributed_cost_float;
    last_contract_cost_float = isNaN(last_contract_cost_float)
      ? 0
      : last_contract_cost_float;

    undistributed_cost =
      undistributed_cost_float + cost_value - last_contract_cost_float;
    var undistributed_cost_tc = undistributed_cost;
    ...
    cost_value = cost_value.toFixed(2) * 1.0;
...
function setMultiselectFillOn(button) {
  if (document.URL.split("/contracts-list/card2/").length == 1) {
    button.className =
      button.className == "ctr_card_multiselect_on"
        ? "ctr_card_multiselect_off"
        : "ctr_card_multiselect_on";
  }
}
...
function saveContract() {
  ...
  var ctr_card_contract_number = document.getElementById(
    "ctr_card_full_contract_number"
  ).value;
  if (document.getElementById("ctr_card_full_parent_number_div")) {
    ...
    if (ctr_card_obj) {
      ctr_card_parent_id = $("#ctr_card_parent_number").val()
        ? $("#ctr_card_parent_number").val()
        : document.getElementById("ctr_card_full_parent_number").value;
    }
  ...
  var ctr_card_status_name = document.getElementById(
    "ctr_card_full_status_name"
  ).value;
  var user_card_allow = document.getElementById("user_card_allow").checked;
  var ctr_card_contractor = document.getElementById(
    "ctr_card_contractor"
  ).value;
  var ctr_card_fot_value = document.getElementById("ctr_card_fot_value").value;
  var ctr_card_contract_description = document.getElementById(
    "ctr_card_contract_description"
  ).value;
  var ctr_card_cost = document.getElementById("ctr_card_full_cost").value;
  var ctr_card_contract_full_vat_label = document.getElementById(
    "ctr_card_contract_full_vat_label"
  ).innerText;
  var ctr_card_contract_full_prolongation_label = document.getElementById(
    "ctr_card_contract_full_prolongation_label"
  ).value;
  ctr_card_contract_full_prolongation_label = false; //Функционал автопродления не введен
  var ctr_card_date_start = document.getElementById(
    "ctr_card_date_start"
  ).value;
  ctr_card_date_start = ctr_card_date_start
    ? convertDate(ctr_card_date_start)
    : null;
  var ctr_card_date_finish = document.getElementById(
    "ctr_card_date_finish"
  ).value;
  ctr_card_date_finish = ctr_card_date_finish
    ? convertDate(ctr_card_date_finish)
    : null;

  var type_id = document.getElementById("contract_type").innerText;

  var cc_obj = document.getElementById("ctr_card_full_obj_label");
  var cc_contract_number = document.getElementById(
    "ctr_card_full_contract_number_label"
  );
  var cc_partner = document.getElementById("ctr_card_partner_label");
  var cc_status_name = document.getElementById(
    "ctr_card_status_full_name_label"
  );
  ...
  if (tab_numRow[0].className != "div_tow_first_row") {
    for (let i of tab_numRow) {
      let tow_checkBox = i.getElementsByClassName("checkbox_time_tracking")[0]
        .checked;
      if (tow_checkBox) {
        ...
        list_towList.push({
          ...
          percent:
            i.getElementsByClassName("tow_cost_percent")[0].dataset.value,
          dept_id: dept_id,
...
function setNewRowContractFunc(conRow) {
  ...
  conRow
    .getElementsByClassName("checkbox_time_tracking")[0]
    .addEventListener("click", function () {
      selectContractTow(this);
    });
  conRow
...
function changeObjectInCard() {
  ...
  if (document.URL.split("/contracts-list/card2/new/").length > 1) {
    ...
    console.log(
      "Изменить объект можно только при создании нового договора/доп.соглашения"
    );
    return alert(
      "Изменить объект можно только при создании нового договора/доп.соглашения"
    );
  ...
  fetch(`/tow-list-for-object/${object_id}/${type_id}/${contract_id}`, {
    ...
    .then((data) => {
      if (data.status === "success") {
        ...
        if (
          contract_id == "new" &&
          document.getElementById("ctr_card_parent_number")
        ) {
          // Обновляем список договоров из карточки договора
          var contract_list_select = document.getElementById(
            "ctr_card_parent_number"
          );
        ...
        if (data.tow.length) {
          for (let t of data.tow) {
            ...
            tow_subcontractor_cost.setAttribute(
              "data-value",
              t.tow_subcontractor_cost
            );
          ...
          button_tow_first_cell.addEventListener("click", function () {
            FirstRow();
          });
