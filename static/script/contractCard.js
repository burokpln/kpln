$(document).ready(function () {
  ...
  document.getElementById("ctr_card_full_obj")
    ? document
        .getElementById("ctr_card_full_obj")
  ...
  document.getElementById("ctr_card_full_contract_number")
    ...
    : "";
  document.getElementById("ctr_card_full_status_name")
    ? document
        .getElementById("ctr_card_full_status_name")
        .addEventListener("change", function () {
          editContractCardData(this);
        })
    : "";
  document.getElementById("ctr_card_full_cost")
    ? document
        .getElementById("ctr_card_full_cost")
  ...
  document.getElementById("id_ctr_hide_full_card_info_button")
    ...
    : "";
  document.getElementById("ctr_card_obj")
    ? document
        .getElementById("ctr_card_obj")
        .addEventListener("change", function () {
          editContractCardData(this);
        })
    : "";
  document.getElementById("ctr_card_contract_number")
    ...
    : "";
  document.getElementById("ctr_card_status_name")
    ? document
        .getElementById("ctr_card_status_name")
        .addEventListener("change", function () {
          editContractCardData(this);
        })
    : "";
  document.getElementById("ctr_card_cost")
    ? document
        .getElementById("ctr_card_cost")
        .addEventListener("focusin", function () {
          convertCost(this, "in");
        })
    : "";
...
function selectContractTow(check_box) {
  ...
  while (nextRow && tow_lvl > cur_lvl) {
    ...
    if (tow_lvl > cur_lvl) {
      ...
      console.log(tow_id, tow_lvl, "  tow_cnt", tow_cnt);
      ...
      console.log(
        new_status,
        nextRow.getElementsByClassName("checkbox_time_tracking")[0]
      );
      if (
...
function undistributedCost(cell, percent = false, input_cost = false) {
  ...
  console.log("fot_cost_percent", fot_cost_percent);
...
function editContractCardStatusName(val) {
  ...
  console.log(
    val == select1,
    val == select2,
    $("#select2-ctr_card_full_status_name-container").text()
  );
}
