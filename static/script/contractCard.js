$(document).ready(function() {
    ...
    document.getElementById('ctr_card_date_start')? document.getElementById('ctr_card_date_start').addEventListener('focusin', function() {convertOnfocusDate(this);}):'';
    document.getElementById('ctr_card_date_start')? document.getElementById('ctr_card_date_start').addEventListener('focusout', function() {convertOnfocusDate(this);}):'';
    document.getElementById('ctr_card_date_finish')? document.getElementById('ctr_card_date_finish').addEventListener('focusin', function() {convertOnfocusDate(this);}):'';
    document.getElementById('ctr_card_date_finish')? document.getElementById('ctr_card_date_finish').addEventListener('focusout', function() {convertOnfocusDate(this);}):'';
...
//    var new_status = check_box.getElementsByClassName("checkbox_time_tracking")[0].checked;
    ...
    while (nextRow && tow_lvl > cur_lvl) {
        ...
        if (tow_lvl > cur_lvl) {
            ...
            console.log(new_status, nextRow.getElementsByClassName("checkbox_time_tracking")[0])
            if (!nextRow.getElementsByClassName("checkbox_time_tracking")[0].disabled) {
                ...
                undistributedCost(nextRow.getElementsByClassName("tow_cost_percent")[0], 'percent');
            }
